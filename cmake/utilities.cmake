...
function(list_sources dir listvar)
    file(GLOB _t_sources_
            ${dir}/*.c
            ${dir}/*.cpp
            ${dir}/*.s
            ${dir}/*.S
        )
    list(APPEND _t_sources_ ${_t_sources_})
endfunction()

function(target_sources_batch target dir)
    file(GLOB _t_sources_
            ${dir}/*.c
            ${dir}/*.cpp
            ${dir}/*.s
    ...
    target_sources(${target} PRIVATE ${_t_sources_})
endfunction()
